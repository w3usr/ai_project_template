...
The club operates under a federal license and carries the University of Scranton's name.
Careless AI use here risks the club's standing with the University, with grant funders, and
with the amateur radio community. Treat what follows as hard constraints.
...
- Human oversight and review of all AI-generated content is required before it is published,
  submitted, printed, or transmitted
...
### 2. FCC Part 97 and the Control Operator
Amateur radio is a licensed service. Every transmission has a human control operator who is
responsible for it. AI tools have no operating privileges and cannot hold a license.

The operating rules live in `.claude/rules/amateur-radio-operations.md`, which applies to
every project in this repository. Read it before doing anything that touches the station,
a logging system, a digital mode, or a remote-control path.

### 3. HamSCI Generative AI Use Agreement (January 2026)
...
### 4. NASA Guidance on Generative AI in Funded Research
...
### 5. NSF Guidance on Responsible Use of Generative AI in Funded Research
...
### 6. Grant Funders (ARDC and others)
...
## AI Is Not an Author and Not an Operator
...
- AI tools cannot be a control operator, cannot key a transmitter, and cannot be credited
  with a QSO. See `.claude/rules/amateur-radio-operations.md`.
- A human club member's name goes on every artifact, and that person is accountable for it.

## What AI Should Never Do Here

- Fabricate or hallucinate citations, references, data, quotations, QSO records, or log entries
...
- Originate, compose, or schedule anything that is transmitted, without a control operator
  reviewing it first
